package net.synergy.utils.generics;
...
public class UtilTime {
  ...
  public static String simpleTimeFormat(long time) {
    ...
    return mins < 1.0D
        ? decimalFormat.format(secs) + " Seconds"
        : (hours < 1.0D ? decimalFormat.format(mins % 60.0D) + " Minutes"
            : (days < 1.0D ? decimalFormat.format(hours % 24.0D) + " Hours"
                : months < 1.0D ? decimalFormat.format(days % 30.0D) + " Days"
                    : decimalFormat.format(months) + " Months"));
  }
  ...
  public static String formatTime(long time) {
    ...
    if (mins == 0) {
      ...
      return days + " days, " + hours % 24 + " hours, " + mins % 60 + " minutes, " + secs % 60
          + " seconds";
    }
  }
